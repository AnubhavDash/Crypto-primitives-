 ...
 */
public class TestArgumentGenerator {
	...
	public TestArgumentGenerator(final GqGroup gqGroup) {
	...
	public ShuffleArgument genShuffleArgument(final int m, final int n, final int l) {
