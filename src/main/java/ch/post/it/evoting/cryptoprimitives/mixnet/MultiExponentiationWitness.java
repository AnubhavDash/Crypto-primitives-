...
public final class MultiExponentiationWitness {
	 ...
	 */
	public MultiExponentiationWitness(final GroupMatrix<ZqElement, ZqGroup> A, final GroupVector<ZqElement, ZqGroup> r, final ZqElement rho) {
