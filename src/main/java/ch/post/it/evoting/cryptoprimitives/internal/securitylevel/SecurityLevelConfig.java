...
public class SecurityLevelConfig {
	...
	/**
	 * Gets the system security level provided by the environment variable SECURITY_LEVEL. If SECURITY_LEVEL is not set,
	 * {@link SecurityLevelInternal#STANDARD} is used.
	 *
